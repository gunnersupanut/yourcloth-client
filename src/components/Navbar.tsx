        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-2 md:space-x-3">
            ...
            <NavLink
              ...
              className="relative group p-1.5 md:p-2 rounded-full transition-all duration-300"
            >
              <ShoppingCart
                className="w-5 h-5 md:w-7 md:h-7 mr-2 text-secondary hover:scale-105 transition-colors"
                strokeWidth={2.5}
              />
              {totalItems > 0 && (
